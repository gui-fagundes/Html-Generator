...
function buildForm() {
  const titleTxt = document.querySelector('#formTitle').value.trim() || 'Formulário';
...
function buildFooter() {
  const msg = document.querySelector('#footerCopyright').value.trim() || '© 2025 All Rights Reserved';
...
document.querySelector('#footerCopyright').addEventListener('input', buildFooter);
